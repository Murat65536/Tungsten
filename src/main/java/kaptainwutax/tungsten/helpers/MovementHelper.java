...
import kaptainwutax.tungsten.constants.render.DebugConstants;
...
//	                System.out.println(isEdgeOnZ);
    ...
    public static boolean isObscured(WorldView world, BlockPos pos, boolean isJumpingUp, boolean isJumpingOneBlock) {
        ...
        if (isJumpingUp && isJumpingOneBlock && isStairs && aboveState.isAir() && !isAboveLeaves && !isAboveX2Leaves && world.getBlockState(pos.up(2)).isAir())
            return false;
